...
jQuery( window ).on( "load", function (){       //FixIn: 2.0.18.1
    ...
    if ( jQuery('.field-text-color').length > 0 ) {
        ...
        .on( 'click', function() {  //FixIn: 2.0.18.4
    ...
    if ( jQuery('.field-background-color').length > 0 ) {
        ...
        jQuery('.field-text-color, .field-background-color').on( 'click', function(event) {  //FixIn: 2.0.18.4
    ...
    if ( jQuery('.wpbm_colorpick').length > 0 ) {
        ...
        jQuery('body').on( 'click', function() {  //FixIn: 2.0.18.4
            jQuery('.iris-picker').hide();
        });

        jQuery('.wpbm_colorpick').on( 'click', function(event) {  //FixIn: 2.0.18.4
            event.stopPropagation();
        });
    }
